...
class PlayerPhysicsSystem(
    ...
    private val playerTransform = player[world]!!
    ...
    private val btWorld = btDiscreteDynamicsWorld(dispatcher, sweep, constraintSolver, collisionConfig)
    ...
    init {
        ...
        btWorld.gravity = Vector3(0f, -9.78f, 0f)

        blocks.forEach { x -> x.forEach { y -> y.forEach { btWorld.addRigidBody(it) } } }

        btWorld.debugDrawer = debugDrawer
    ...
    private fun createPlayerBody(): btRigidBody {
        ...
        btWorld.addRigidBody(playerBody)
    ...
    private fun createPlayerController(): btKinematicCharacterController {
        ...
        btWorld.addAction(playerController)
